...
<section class="orders">
   ...
   <div class="box-container">
      <?php
      $select_orders = mysqli_query($conn, "SELECT * FROM `orders` ORDER BY id DESC") or die('Select query failed');
      ...
      <div class="box">
         ...
         <p> Email: <span><?= $fetch_orders['customer_email']; ?></span> </p>
         <p> Number: <span><?= $fetch_orders['customer_number']; ?></span> </p>
         <p> Address: <span><?= $fetch_orders['customer_address']; ?></span> </p>
